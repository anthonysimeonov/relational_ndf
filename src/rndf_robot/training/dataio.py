...
class JointOccTrainDataset(Dataset):
    def __init__(self, sidelength, depth_aug=False, multiview_aug=False, phase='train', obj_class='all'):
        ...
        mug_path = osp.join(path_util.get_rndf_data(), 'training_data/mug_table_all_pose_4_cam_half_occ_full_rand_scale')
        bottle_path = osp.join(path_util.get_rndf_data(), 'training/bottle_table_all_pose_4_cam_half_occ_full_rand_scale')
        bowl_path = osp.join(path_util.get_rndf_data(), 'training/bowl_table_all_pose_4_cam_half_occ_full_rand_scale')

        ## these are the names of the mini-dataset folders, to ensure everything is up and running
        # mug_path = osp.join(path_util.get_rndf_data(), 'training_data/test_mug')
        # bottle_path = osp.join(path_util.get_rndf_data(), 'training_data/test_bottle')
        # bowl_path = osp.join(path_util.get_rndf_data(), 'training_data/test_bowl')
        ...
        self.shapenet_mug_dict = pickle.load(open(osp.join(path_util.get_rndf_data(), 'training_data/occ_shapenet_mug.p'), 'rb'))
        self.shapenet_bowl_dict = pickle.load(open(osp.join(path_util.get_rndf_data(), 'training_data/occ_shapenet_bowl.p'), "rb"))
        self.shapenet_bottle_dict = pickle.load(open(osp.join(path_util.get_rndf_data(), 'training_data/occ_shapenet_bottle.p'), "rb"))
